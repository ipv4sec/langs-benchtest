...
go build -o dist/ttt t.go

./dist/ttt >> dist/0.txt  2>&1
./dist/ttt >> dist/1.txt  2>&1
./dist/ttt >> dist/2.txt  2>&1
./dist/ttt >> dist/3.txt  2>&1
./dist/ttt >> dist/4.txt  2>&1
./dist/ttt >> dist/5.txt  2>&1
./dist/ttt >> dist/6.txt  2>&1
./dist/ttt >> dist/7.txt  2>&1
./dist/ttt >> dist/8.txt  2>&1
./dist/ttt >> dist/9.txt  2>&1
